...
class constrained_REPS(BlackBoxOptimization):
    """
    ...
    def _update(self, Jep, theta):
        ...
        # REPS
        eta_start = np.ones(1)
        res = minimize(constrained_REPS._reps_dual_function, eta_start,
                       jac=constrained_REPS._reps_dual_function_diff,
        ...
        res = minimize(constrained_REPS._lagrangian_eta_omg, eta_omg_start,
                       jac=grad(constrained_REPS._lagrangian_eta_omg),
        ...
        mu_t1, sig_t1 = constrained_REPS.closed_form_mu_t1_sig_t1(W, theta, mu_t, sig_t, n, self.eps, eta_opt, omg_opt, self.kappa)
        ...
        H_t = constrained_REPS._closed_form_entropy(logdet_sig_t, n)
        H_t1 = constrained_REPS._closed_form_entropy(logdet_sig_t1, n)
        ...
        kl = constrained_REPS._closed_form_KL_constraint_M_projection(mu_t, mu_t1, sig_t, sig_t1, sig_t_inv, sig_t1_inv, logdet_sig_t, logdet_sig_t1, n)
        # print('KL', kl)
        if not kl <= self.eps:
    ...
    def _lagrangian_eta_omg(lag_array, *args):
        ...
        mu_t1, sig_t1 = constrained_REPS.closed_form_mu_t1_sig_t1(W, theta, mu_t, sig_t, n, eps, eta, omg, kappa)
        ...
        sum2 = eta * (eps - constrained_REPS._closed_form_KL_constraint_M_projection(mu_t, mu_t1, sig_t, sig_t1, sig_t_inv, sig_t1_inv, logdet_sig_t, logdet_sig_t1, n))
        
        sum3 = omg * (constrained_REPS._closed_form_entropy(logdet_sig_t1, n) - constrained_REPS._closed_form_entropy(logdet_sig_t, n) + kappa)
