...
def load_data_from_dir(data_dir):
            ...
            for file in files:
                ...
                if file[-4:] != '.txt':
                    ...
                    if returns_mean is None:
                        ...
                        try:
                            print('MIN KL', min(data['kls']))
                            print('MAX KL', max(data['kls']))
                        except:
                            pass
    ...
    return returns_mean_all, returns_std_all, optimal_reward_all, best_reward_all, mi_avg_all, mus_all, legend, init_params
...
if __name__ == '__main__':
    ...
    exp_name = 'lqr_3_env_0_lqr_init'
    exp_name = 'lqr_3_env_0'
    exp_name = 'lqr_2'
    exp_name = 'lqr_2_env_0'
    exp_name = 'lqr_10_env_0_init_1e3'
    exp_name = 'lqr_10_env_0'
    exp_name = 'lqr_10_env_0_sig_1'
    data_dir = os.path.join('logs', exp_name)
    returns_mean_all, returns_std_all, optimal_reward_all, best_reward_all, mi_avg_all, mus_all, legend, init_params = load_data_from_dir(data_dir)
    print('alg', legend)
