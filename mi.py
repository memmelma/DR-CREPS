...
def get_mi(noise_factor=1, dim=5, n_samples=1000, bins=[3,5]):
    ...
    return np.array([I_xy_sklearn_regression, *I_xy_sklearn, I_xy_scipy, I]), legend
...
if __name__ == '__main__':
    ...
    for dim in [5, 10]:
        for n_samples in [25, 100]:
            plot_standard(dim = dim, n_samples = n_samples, bins = [2, 3, 5], noise_factors = np.arange(1, 100, 1), n_runs=25)
